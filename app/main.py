...
# def login_estudiante(ci: Annotated[str, Form()],correo: Annotated[str, Form()],db: Session = Depends(get_db),):
...
Solo inicializa FastAPI, crea las tablas y registra los routers.
"""
from fastapi import FastAPI
from .database import engine, Base
from . import models  # noqa: F401 — registra todos los modelos en Base.metadata
from .routes import usuarios, docentes, estudiantes
 
Base.metadata.create_all(bind=engine)
 
app = FastAPI(title="TecMed API")
